...
def no_parkinsons_page():
    ...
    st.markdown("""
        <div style='text-align: center;'>
            <iframe width="560" height="315" src="<iframe width="1678" height="767" src="https://www.youtube.com/watch?v=gjPt7S2dX_I"</iframe>" frameborder="0" allowfullscreen></iframe>
        </div>
    """, unsafe_allow_html=True)
